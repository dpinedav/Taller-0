...
public class ConsolaOlimpicos
{
	...
	public void ejecutarAplicacion()
	{
		...
		while (continuar)
		{
			try
			{
				...
				{
					String nombre= input("Ingresar el nombre del atleta a Buscar");
					ejecutarCargarPaisAtleta(nombre);
				}
	...
	private void ejecutarCargarPaisAtleta(String nombreAtleta)
	{
		String nombrePais = calculadora.buscarPaisAtleta(nombreAtleta).darNombre();
